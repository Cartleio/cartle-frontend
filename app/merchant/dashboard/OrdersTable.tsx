...
import { getOrderStatus } from "../../components/utils/data";
import Link from "next/link";
import { format } from "date-fns";

function OrdersTable({ orders, OrderType, lastUpadted }: any) {
  return (
            ...
            <tbody className="">
              {orders.map((order: any) => (
                <tr key={order.id}>
                  ...
                  <td>
                    {getOrderStatus(order.current_order_status.toUpperCase())}
                  </td>
