    ...
    <section className="bg-transparent mt-20 mb-20 relative overflow-hidden">
      <div className="grid pl-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 relative z-10">
        <div className="lg:mr-20 place-self-center lg:col-span-7">
          ...
          <a href="#" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg  hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 py-4 bg-[#FF7600]">
