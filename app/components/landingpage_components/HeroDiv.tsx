    ...
    <section className="bg-transparent mt-20 mb-20 relative overflow-hidden">
      <div className="grid pl-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 relative z-10">
        <div className="lg:mr-20 place-self-center lg:col-span-7">
          <animated.h1 style={textAnimationProps} className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-black">
            {texts[index]} 
            <br /> WITH <span className="mt-4 text-[#FF7600]"> CARTLE</span>
          </animated.h1>
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl text-gray-700">Cartle is making commerce easier for African entrepreneurs, setting them up to grow, compete and win globally</p>
          <a href="/auth/register" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg  hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 py-4 bg-[#FF7600]">
        ...
        <div className="lg:mt-0 lg:col-span-5 lg:flex lg:justify-end">
          <animated.div style={{ ...imageAnimationProps, position: 'relative', zIndex: 1 }}>
            <Image
