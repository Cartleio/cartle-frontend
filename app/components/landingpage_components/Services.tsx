  ...
  const services = [
    {
      ...
      icon: (
        ...
        >
          <path
            d="M21.6063 11.8112C21.6064 10.51 21.3476 9.22169 20.8446 8.02161C20.3415 6.82155 19.6047 5.73371 18.6768 4.82145C17.7489 3.90921 16.6486 3.19089 15.4401 2.70839C14.2318 2.22588 12.9393 1.9889 11.6383 2.01121C9.14071 2.08548 6.76264 3.09763 4.97769 4.84623C3.19276 6.59485 2.13189 8.95162 2.00629 11.4472C1.9466 13.1125 2.3125 14.7655 3.06945 16.25C3.8264 17.7344 4.9494 19.0014 6.33228 19.9312C6.72202 20.1846 7.04254 20.5309 7.26496 20.939C7.48738 21.3473 7.6047 21.8044 7.60629 22.2692V24.4112H16.0063V22.2692C16.0063 21.8056 16.1215 21.3494 16.3415 20.9413C16.5614 20.5332 16.8792 20.1861 17.2663 19.9312C18.5994 19.0367 19.6925 17.8284 20.4492 16.4126C21.206 14.9967 21.6034 13.4166 21.6063 11.8112Z"
            stroke="#FF6B3A"
            stroke-width="3"
            strokeLinecap="round"
          ...
          />
          <path
            d="M16.0094 28.625C14.7977 29.5337 13.324 30.025 11.8094 30.025C10.2947 30.025 8.82105 29.5337 7.60938 28.625"
            stroke="#FF6B3A"
            stroke-width="3"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    },
    {
      ...
      cardBody:
        "Introduce this business to your social media platforms and tell your friends.",
    ...
    },
    {
      ...
      cardBody:
        "Setup your events and add paid or free tickets on your profile, help your customers reserve seats for your trainings with ease.",
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M34.4323 5.84277H19.849V7.00944H33.849V33.8428H1.18229V7.00944H15.1823V5.84277H0.598958C0.248958 5.84277 0.015625 6.07611 0.015625 6.42611V34.4261C0.015625 34.7761 0.248958 35.0094 0.598958 35.0094H34.4323C34.7823 35.0094 35.0156 34.7761 35.0156 34.4261V6.42611C35.0156 6.07611 34.7823 5.84277 34.4323 5.84277Z"
            fill="#FF6B3A"
          />
          <path
            d="M0.015625 0.00976562V1.17643H16.9323V9.3431H4.09896C3.74896 9.3431 3.51562 9.57643 3.51562 9.92643V20.4264C3.51562 20.7764 3.74896 21.0098 4.09896 21.0098H30.9323C31.2823 21.0098 31.5156 20.7764 31.5156 20.4264V9.92643C31.5156 9.57643 31.2823 9.3431 30.9323 9.3431H18.099V1.17643H35.0156V0.00976562H0.015625ZM30.349 19.8431H4.68229V10.5098H30.349V19.8431Z"
            fill="#FF6B3A"
          />
          <path
            d="M22.7682 18.0931H23.9349C24.6349 18.0931 25.1016 17.6264 25.1016 16.9264V15.7598C25.1016 15.0598 24.6349 14.5931 23.9349 14.5931H22.7682V13.4264H23.9349V14.0098H25.1016V13.4264C25.1016 12.7264 24.6349 12.2598 23.9349 12.2598H22.7682C22.0682 12.2598 21.6016 12.7264 21.6016 13.4264V14.5931C21.6016 15.2931 22.0682 15.7598 22.7682 15.7598H23.9349V16.9264H22.7682V16.3431H21.6016V16.9264C21.6016 17.6264 22.0682 18.0931 22.7682 18.0931Z"
            fill="#FF6B3A"
          />
          <path
            d="M16.349 18.0931H18.6823C19.3823 18.0931 19.849 17.6264 19.849 16.9264V13.4264C19.849 12.7264 19.3823 12.2598 18.6823 12.2598H16.349C15.999 12.2598 15.7656 12.4931 15.7656 12.8431V17.5098C15.7656 17.8598 15.999 18.0931 16.349 18.0931ZM16.9323 13.4264H18.6823L18.7406 16.9264H18.6823H16.9323V13.4264Z"
            fill="#FF6B3A"
          />
          <path
            d="M11.0964 16.3431H12.8464V18.0931H14.013V12.8431C14.013 12.4931 13.7797 12.2598 13.4297 12.2598H10.513C10.163 12.2598 9.92969 12.4931 9.92969 12.8431V18.0931H11.0964V16.3431ZM12.8464 13.4264V15.1764H11.0964V13.4264H12.8464Z"
            fill="#FF6B3A"
          />
          <path
            d="M28.0182 14.5928H26.8516V15.7594H28.0182V14.5928Z"
            fill="#FF6B3A"
          />
          <path
            d="M8.18229 14.5928H7.01562V15.7594H8.18229V14.5928Z"
            fill="#FF6B3A"
          />
          <path
            d="M31.5156 23.3431C31.5156 22.9931 31.2823 22.7598 30.9323 22.7598H4.09896C3.74896 22.7598 3.51562 22.9931 3.51562 23.3431V28.0098C3.51562 28.3598 3.74896 28.5931 4.09896 28.5931H30.9323C31.2823 28.5931 31.5156 28.3598 31.5156 28.0098V23.3431ZM30.349 27.4264H4.68229V23.9264H30.349V27.4264Z"
            fill="#FF6B3A"
          />
          <path
            d="M4.68229 30.9268H3.51562V32.0934H4.68229V30.9268Z"
            fill="#FF6B3A"
          />
          <path
            d="M7.01823 30.9268H5.85156V32.0934H7.01823V30.9268Z"
            fill="#FF6B3A"
          />
          <path
            d="M9.34635 30.9268H8.17969V32.0934H9.34635V30.9268Z"
            fill="#FF6B3A"
          />
          <path
            d="M26.8464 30.9268H25.6797V32.0934H26.8464V30.9268Z"
            fill="#FF6B3A"
          />
          <path
            d="M24.5156 30.9268H10.5156V32.0934H24.5156V30.9268Z"
            fill="#FF6B3A"
          />
          <path
            d="M29.1823 30.9268H28.0156V32.0934H29.1823V30.9268Z"
            fill="#FF6B3A"
          />
          <path
            d="M31.5182 30.9268H30.3516V32.0934H31.5182V30.9268Z"
            fill="#FF6B3A"
          />
        </svg>
      ),
      ...
      cardBody:
        "Explore our list of templates, post your business link on all social platforms. Boost your sales by telling people about it and design a website for your business of your dreams.",
      buttonText: "Join Waitlist",
    },
    {
      id: useId(),
      icon: (
        ...
        >
          <path
            d="M16.7817 5.02856V7.01099H19.2803V0.759521H13.0322V3.25806H15.0146L10.3696 7.89966L6.62012 5.40112L0.898438 11.1262L2.66553 12.8933L6.94141 8.61743L10.6909 11.1194L16.7817 5.02856ZM1.78027 15.761H10.5303V18.2595H1.78027V15.761Z"
            fill="#FF6B3A"
          />
        </svg>
      ),
        ...
        <section className="grid gap-16 pt-6 pb-8 bg-[transparent] px-3 lg:px-20">
          <div className="grid gap-4 lg:text-center">
            <h2 className="text-3xl sm:text-2xl font-bold leading-[120%] text-black  lg:text-5xl lg:leading-[120%]">
              ...
              <span className="text-[#FF7600]"> Cartle</span>
            </h2>

            <p className="text-gray-500">
              Cartle is designed to help you grow your business at every stage.
              Whether you are just started or you are looking to scale. We have
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {services.map(
              (service): JSX.Element => (
                <div
                  className="cursor-pointer border border-gray-50 rounded-2xl bg-white p-8 grid gap-10 shadow-sm transition-colors duration-300 ease-in-out group/card hover:bg-[#FF7600] hover:text-gray-300"
                  key={service.id}
                >
