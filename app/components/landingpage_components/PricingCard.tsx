            ...
            {pricingData.map((tier, index) => (
              ...
              >
                ...
                <button
                  ...
                  className={`w-full mt-6 py-3 px-4 rounded-md border-0 text-[#FF7600] shadow-xl hover:bg-indigo-600 border border-indigo-200 hover:text-white bg-white ${
                    selectedPlan === index
