        ...
        <div className="flex items-center gap-4 flex-col sm:flex-row  my-8 justify-center">
          <div className="bg-white p-8 rounded-md lg:mr-8 shadow-sm">
            ...
            <div className="flex items-center">
              ...
              >
                <path
                  d="M20 1V5L10 9L0 5V1C0 0.734784 0.105357 0.48043 0.292893 0.292893C0.48043 0.105357 0.734784 0 1 0H19C19.2652 0 19.5196 0.105357 19.7071 0.292893C19.8946 0.48043 20 0.734784 20 1ZM0 7.154V15C0 15.2652 0.105357 15.5196 0.292893 15.7071C0.48043 15.8946 0.734784 16 1 16H19C19.2652 16 19.5196 15.8946 19.7071 15.7071C19.8946 15.5196 20 15.2652 20 15V7.154L10 11.154L0 7.154Z"
                  fill="#FF7600"
                />
              </svg>
              <div className="flex flex-col">
